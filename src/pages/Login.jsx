  ...
  return (
    <div className="flex justify-center items-center min-h-screen text-slate-800">
      <div className="shadow max-w-sm md:max-w-lg w-full rounded-lg p-8">
        ...
        <p className="mb-2 text-xs font-light">Belum punya akun?<Link to={"/register"} className="text-cyan-600 font-normal"> Register</Link></p>
        <form action="">
          ...
          <Link to={"/"}><Button children={"Login"}/></Link>
        </form>
      </div>
    </div>
  );
