  ...
  return (
    <div className="flex justify-center items-center min-h-screen text-slate-800">
      <div className="shadow max-w-sm md:max-w-lg w-full rounded-lg p-8">
        <h1 className="text-3xl font-bold text-cyan-600 -mt-3 mb-2">Register</h1>
        <p className="mb-2 text-xs font-light">Sudah punya akun?<Link to={"/login"} className="text-cyan-600 font-normal"> Login</Link></p>
        <form action="">
          ...
          <Link to={"/login"}><Button children={"Register"}/></Link>
        </form>
      </div>
    </div>
  );
